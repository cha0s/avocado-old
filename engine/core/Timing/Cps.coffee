...
# engine itself. If you instantiate avo.**Cps** and call avo.**Cps**::tick()
# every time a process runs, you can call avo.**Cps**::count() to found how
# many times the cycle runs per second.
# 
# *NOTE:* When you instantiate avo.**Cps**, a **frequency** is specified. You
# must call avo.**Cps**.tick() for at least **frequency** milliseconds to get
